...
class AlignmentOptions:
    ...
    stretch_method: Literal["resample", "pitch_preserving", "rubberband", "soxr", "audiostretchy"] = "resample"
...
def build_cli_argv(options: AlignmentOptions) -> list[str]:
    ...
    allowed_methods = {"resample", "pitch_preserving", "rubberband", "soxr", "audiostretchy"}
